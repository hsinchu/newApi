<template>
	<view class="span">
		...
		<view class="number-container">
			<view class="number-label">选择跨度（0-9）</view>
		...
		<view class="span-info">
			<view class="info-title">跨度说明</view>
			<view class="info-content">
				<text class="info-text">跨度 = 开奖号码最大数字 - 最小数字</text>
				<text class="info-example">例如：开奖号码 357，跨度 = 7 - 3 = 4</text>
			</view>
		</view>

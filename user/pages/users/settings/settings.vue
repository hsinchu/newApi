		...
		<view class="scroll-container">
			...
			<view class="section">
				...
				<view class="avatar-section">
					<text class="item-label">用户头像</text>
				...
				<!-- 投注返佣 -->
				<view class="setting-item">
					<text class="item-label">投注返佣比例</text>
					<view class="item-content">
						<text class="item-value">{{userInfo.rebate_rate}}%</text>
					</view>
				</view>
				
				<!-- 不中奖返佣 -->
				<view class="setting-item">
					<text class="item-label">不中奖返佣比例</text>
					<view class="item-content">
						<text class="item-value">{{userInfo.nowin_rate}}%</text>
					</view>
				</view>
			</view>
...
<script>
import { getUserInfo, updateUserProfile, uploadAvatar, changePassword, changePayPassword } from '@/api/user.js';
